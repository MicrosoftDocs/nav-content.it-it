...
I conti correnti bancari vengono utilizzati in Dynamics NAV per tenere traccia delle transazioni bancarie. I conti possono essere denominati in valuta locale o estera. Dopo aver impostato i conti correnti bancari è possibile utilizzare l'opzione per la stampa di assegni.
...
**Nota**: in campi nella nella Scheda dettaglio **Trasferimento** sono correlati all'importazione/esportazione dei feed e dei file della banca. Per ulteriori informazioni, vedere [Procedura: Impostare il servizio di conversione di dati bancari](bank-how-setup-bank-data-conversion-service.md).
