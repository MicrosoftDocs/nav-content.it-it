...
---
# <a name="how-to-flush-components-according-to-operation-output"></a>Procedura: Eseguire la consuntivazione dei componenti in base all'output dell'operazione
...
5.  Definire codici di legame tra ciclo e distinta base per ogni operazione che consuma il componente. Per ulteriori informazioni, vedere [Procedura: Creare cicli](production-how-to-create-routings.md).  
