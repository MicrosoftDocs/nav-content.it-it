...
# <a name="the-c5-data-migration-extension-for-dynamics-nav"></a>Estensione di migrazione dati C5 per Dynamics NAV
...
> [!Note]
> Ricordare che vengono migrati solamente i movimenti aperti. Non saranno presenti dati storici.
