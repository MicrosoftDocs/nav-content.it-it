...
## <a name="define-an-organizational-level-code"></a>Definire un codice livello organizzativo
...
1. Nell'angolo superiore destro, scegliere l'icona **Cerca pagina o report**, immettere **Livelli organizzativi**, quindi scegliere il collegamento correlato.
...
## <a name="assign-organizational-levels-to-a-contact-person"></a>Assegnare i livelli organizzativi ai contatti
