...
# <a name="how-to-work-with-the-consolidated-trial-balance-report"></a>Procedura: Utilizzare il report Bilancio di verifica consolidato
...
4. Nel gruppo **Tassi di cambio** della scheda **Naviga** selezionare **Tasso di chiusura**.  
...
## <a name="to-export-data-from-dynamics-nav-and-import-it-in-included365finincludesd365finmdmd"></a>Per esportare i dati da Dynamics NAV e importarli in [!INCLUDE[d365fin](includes/d365fin_md.md)]
