...
---
# <a name="the-quickbooks-payroll-file-import-extension-to-dynamics-nav"></a>Estensione per l'importazione del file retribuzioni di Quickbooks in Dynamics NAV
