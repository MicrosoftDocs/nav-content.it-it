...
# <a name="how-to-apply-vendor-payments-manually"></a>Collegare i pagamenti ai fornitori manualmente
...
È necessario abilitare il collegamento dei movimenti contabili fornitori in differenti valute. Per ulteriori informazioni, vedere [Procedura: Abilitare il collegamento dei movimenti contabili fornitore in valute diverse](finance-setup-how-enable-application-ledger-entries-different-currencies.md)
