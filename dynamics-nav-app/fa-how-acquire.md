...
2. Scegliere l'azione **Nuovo** e compilare i campi necessari della Scheda dettaglio **Generale**. Selezionare il campo per visualizzare una breve descrizione del campo o il collegamento a ulteriori informazioni.
...
**Note**: è inoltre possibile registrare i costi di acquisizione in Avere. In tal caso, ricordare che il valore nel campo **Costo di acquisizione IVA inclusa** deve avere il segno meno per indicare un credito.
...
il bene principale e tutti i suoi componenti devono essere impostati come schede cespiti individuali. In seguito all'impostazione di una lista di componenti, i campi **Bene Principale/Componente** e **Componenti del Cespite** nelle schede cespiti vengono compilati automaticamente in Dynamics NAV.
...
6. Nell'angolo superiore destro, scegliere l'icona **Cerca pagina o report**, immettere **Setup cespiti**, quindi scegliere il collegamento correlato.
...
**Note**: è inoltre possibile registrare i costi di acquisizione in Avere. In tal caso, ricordare che il valore nel campo **Importo** deve avere il segno meno per indicare un credito.
...
**Suggerimento**: se durante la registrazione di un costo di acquisto viene compilato il campo **Nr. assicurazione** il costo di acquisizione del cespite verrà registrato da Dynamics NAV nel registro copertura assicurativa. Per ulteriori informazioni, vedere [Procedura: Assicurazione di cespiti](fa-how-insure.md).
...
1. Nell'angolo superiore destro, scegliere l'icona **Cerca pagina o report**, immettere **Rimuovi mov. cespiti**, quindi scegliere il collegamento correlato.
