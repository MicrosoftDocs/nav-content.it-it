...
---
# <a name="how-to-create-special-orders"></a>Procedura: Creare ordini speciali
...
2. Scegliere l'azione **Nuovo**. Creare e compilare un  ordine di vendita per l'articolo. Per ulteriori informazioni, vedere [Procedura: Vendere prodotti](sales-how-sell-products.md).
