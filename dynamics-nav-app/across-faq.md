...
In caso di domande su [!INCLUDE[d365fin](includes/d365fin_md.md)] per cui non è possibile trovare risposta in questa documentazione, è possibile rivolgersi alla community di Dynamics NAV. Per ulteriori informazioni, vedere Community di [Dynamics NAV, Business edition](https://community.dynamics.com/business). Anche il nostro team del supporto pubblica suggerimenti e consigli. Per ulteriori informazioni, vedere il [blog del supporto di Dynamics NAV](https://blogs.msdn.microsoft.com/dyn365finsupport).  
