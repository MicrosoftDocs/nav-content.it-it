...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a>Per convertire un'offerta di contratto di assistenza in contratto di assistenza  
...
4. Nel campo **Nr. cliente** immettere il numero del cliente relativo al contratto di assistenza.  
    ...
    > [!NOTE]  
    >  È possibile confrontare la nota di credito con il documento originale registrato nella finestra **Fatture assistenza registrate**. Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Fatture assistenza registrate**, quindi scegliere il collegamento correlato.  
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>Per aggiungere una riga di contratto a un contratto di assistenza o a un'offerta di contratto  
...
## <a name="to-remove-contract-lines"></a>Per eliminare le righe di contratto  
...
1. Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), immettere **Contratti assistenza**, quindi scegliere il collegamento correlato. Aprire il contratto di assistenza rilevante di cui si desidera modificare l'intestatario.  
...
1. Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), immettere **Registra mov. contratti prepagati**, quindi scegliere il collegamento correlato.  
...
## <a name="changing-the-service-contract-status"></a>Modifica dello stato del contratto di assistenza
...
## <a name="to-cancel-a-service-contract"></a>Per annullare un contratto di assistenza  
