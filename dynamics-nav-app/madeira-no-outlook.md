...
---
# <a name="using-dynamics-nav-without-outlook"></a>Utilizzo di Dynamics NAV senza Outlook
...
[Benvenuto in Dynamics NAV](index.md)  
[Utilizzo di Dynamics NAV come Posta in arrivo aziendale in Outlook](madeira-outlook.md)  
[Scaricare Dynamics NAV sul dispositivo mobile](install-mobile-app.md)  
