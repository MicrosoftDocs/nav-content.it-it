...
---
# <a name="scenario-example-defining-dynamic-allocations-based-on-items-sold"></a>Esempio di scenario: definizione delle allocazioni dinamiche in base agli articoli venduti
