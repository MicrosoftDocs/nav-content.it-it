...
3. Compilare tutti i campi in modo da creare un conto C/G per le entrate differite. Per ulteriori informazioni, vedere [Contabilità generale e piano dei conti](finance-setup-general-ledger.md).
3. Ripetere i passaggi 2 e 3 per creare un nuovo conto C/G per le spese differite.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report**, immettere **Modelli di differimento**, quindi scegliere il collegamento correlato.
2. Scegliere l'azione **Nuovo**.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report**, immettere **Riepilogo differimento vendite**, quindi scegliere il collegamento correlato.
