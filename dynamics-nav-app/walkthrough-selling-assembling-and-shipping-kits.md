...
1.  Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Setup manufacturing**, quindi scegliere il collegamento correlato.  
...
Samuele, il responsabile spedizioni, riceve tre righe di spedizione warehouse relative all'ordine di vendita: una riga per le tre unità di ATO pure, una riga per le cinque unità di ATO nella riga dell'ordine di vendita mista e una riga per le dieci unità di ATS nella riga dell'ordine di vendita mista. Crea un documento di prelievo warehouse per tutti i componenti di assemblaggio necessari per l'assemblaggio di tutte e otto unità di ATO nel documento di spedizione warehouse.  

Gianni, l'addetto al prelievo, recupera i componenti per tutte le quantità di ATO indicate nel documento di spedizione warehouse e li porta nell'area di assemblaggio. Immette la quantità da gestire e registra il prelievo warehouse.  
...
1.  Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Registrazioni articoli whse.**, quindi scegliere il collegamento correlato.  
...
4.  Nel gruppo **Registrazione** della scheda **Pagina iniziale** selezionare **Registro** e fare clic sul pulsante **Sì**.  

    A questo punto, è necessario sincronizzare i nuovi movimenti warehouse con il magazzino.  

5.  Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Registrazioni inventario fisico**, quindi scegliere il collegamento correlato. Viene visualizzata la finestra **Registrazioni magazzino**.  
...
4.  Nella scheda **Naviga**, nel gruppo **Assemblaggio/Produzione**, selezionare **Assemblaggio**, quindi scegliere **DB assemblaggio**.  
...
7.  Nella scheda **Naviga**, nel gruppo **Assemblaggio/Produzione**, selezionare **Assemblaggio**, quindi scegliere **DB assemblaggio**.  
...
16. Nel gruppo **Rilascio** della scheda **Azioni** scegliere **Rilascia**.  
17. Nel gruppo **Warehouse** della scheda **Azioni** scegliere **Crea spedizione whse.**  
...
3.  Nel gruppo **Funzioni** della scheda **Azioni**, selezionare **Crea prelievo**, quindi scegliere **OK**.  

    A questo punto, è necessario eseguire il task di prelievo.  

4.  Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Prelievi**, quindi scegliere il collegamento correlato.  
...
6.  Nel gruppo **Funzioni** della scheda **Azioni** scegliere **Autocompil. qtà da gestire**.  
7.  Nella scheda **Pagina iniziale** del gruppo **Registrazione**, scegliere **Registra prelievo**.  
...
1.  Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Ordini di assemblaggio**, quindi scegliere il collegamento correlato.  
...
3.  Nel gruppo **Rilascio** della scheda **Azioni** scegliere **Rilascia**.  
4.  Nel gruppo **Warehouse** della scheda **Azioni**, selezionare **Crea prelievo whse.**, quindi scegliere **OK**.  

    A questo punto, è necessario eseguire il task di prelievo.  

5.  Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Prelievi**, quindi scegliere il collegamento correlato.  
...
7.  Nel gruppo **Funzioni** della scheda **Azioni** scegliere **Autocompil. qtà da gestire**.  
8.  Nella scheda **Pagina iniziale** del gruppo **Registrazione**, scegliere **Registra prelievo**.  

    Tornare all'ordine di assemblaggio per eseguire l'ultimo task di assemblaggio.  

9. In **Ordine di assemblaggio**, scheda **Azioni**, gruppo **Registrazione**, scegliere **Registra**, quindi fare clic sul pulsante **Sì**.  
...
6.  Nel gruppo **Funzioni** della scheda **Azioni** scegliere **Autocompil. qtà da gestire**.  
7.  Nel gruppo **Registrazione** della scheda **Pagina iniziale** selezionare **Registra prelievo** e fare clic sul pulsante **Sì**.  
...
10. Scegliere l'icona ![Cerca pagina o report](media/ui-search/search_small.png "Cerca pagina o report"), immettere **Ordini vendita**, quindi scegliere il collegamento correlato  
